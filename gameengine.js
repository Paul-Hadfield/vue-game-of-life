...
const includeNeighbours = (cell, currentCell) => {
    return (cell.x >= (currentCell.x - 1) & cell.x <= (currentCell.x + 1)) && (cell.y >= (currentCell.y - 1) & cell.y <= (currentCell.y + 1))
}
...
const GameEngine = {
    ...
    determineNewState : (cell, currentGrid) => {
        return {x: cell.x, y: cell.y, live: applyRules(cell.live, getNumberOfLiveNeighbours(cell, currentGrid))};
    }
}
